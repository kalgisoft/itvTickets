...
namespace ItvTicketsService.Client.Services
{
    ...
    public class TicketService : ITicketService
    {
        ...
        public async Task<HttpResponseMessage> UpdateTicketFlag(int tkid, int flag)
        {
            var result = await _httpClient.PostAsJsonAsync("api/ticket/TicketsUpdateFlag", new List<int> { tkid, flag });
            return result;
        }
